...
from networks import utils, activations, costs


class Network(object):
    def __init__(self, sizes, cost=costs.CrossEntropyCost):
    ...
    def fit(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in range(epochs):
            ...
            if monitor_training_accuracy:
                ...
                print("Accuracy on training data: %i%%"
                      % int(100 * float(accuracy) / n))
    ...
    def backprop(self, x, y):
        ...
        nabla_b[-1] = delta
        nabla_w[-1] = np.dot(delta, os[-2].transpose())
        ...
        for l in range(2, self.num_layers):
            ...
            nabla_b[-l] = delta
            nabla_w[-l] = np.dot(delta, os[-l - 1].transpose())
    ...
    def total_cost(self, data, lmbda, convert=False):
        ...
        for x, y in data:
            ...
            if convert: y = utils.one_hot_encoding(y)
